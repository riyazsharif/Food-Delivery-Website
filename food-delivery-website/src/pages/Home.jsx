  ...
  return (
    <div className='bg-slate-200 w-full min-h-screen'>
      ...
      <div className='w-full flex flex-wrap gap-5 px-5  justify-center items-center pt-8 pb-8'>
        ...
        )) : <div className='text-center text-2xl text-green-500 font-semibold pt-6 flex  flex-col justify-center items-center'>No Dish found</div>}
      
      </div>
      <div className={`w-full md:w-[40vw] h-[100%] fixed top-0 right-0 bg-white shadow-lg p-6 transition-all duration-500 flex flex-col items-center overflow-auto ${showCart?"translate-x-0":"translate-x-full"}`} >
        <header className='w-[100% flex justify-between items-center '>
          <span className='text-green-400 text-[18px] font-semibold'>Oder items</span>
  ...
  />
        ...
        <div className='w-full border-t-2 border-b-2 border-gray-400 mt-7 flex flex-col gap-2 p-8'>
         ...
         <div className='w-full flex justify-between items-center p-9'>
          ...
          <button className='w-[80%] p-3 rounded-lg bg-green-500  text-white hover:bg-green-300 transition-all ' onClick={() => {
            toast.success("Order Placed....")
          }}>Place Order</button>
        </> : <div className='text-center text-2xl text-green-500 font-semibold pt-6'>
          Empty Cart.....
        </div>
        }
      </div>
